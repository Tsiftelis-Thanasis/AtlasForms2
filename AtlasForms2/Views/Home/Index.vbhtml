            ...
            @*<div class="widget kopa-sync-carousel-widget">
                <div class="owl-carousel sync1">*@
                    @*<div class="item">
                        <article class="entry-item">
                            ...
                            <div class="entry-content">
                                <h4 class="entry-title"><a href="#">ΧΑΒΑΛΕΝΘΙΑ vs €- FRIENDS </a></h4>
                                <h5><span><b>ΔΗΛΩΣΕΙΣ ΝΙΚΗΤΩΝ...</b></span></h5>
                            </div>
                            <span></span>
                        </article>
                    </div>
                    <div class="item">
                        <article class="entry-item">
                            <div class="entry-thumb">
                                <a href="#"><img src="~/Content/images/slider/s2.png" alt=""></a>
                                <div class="thumb-hover"></div>
                            </div>
                            <div class="entry-content">
                                <h4 class="entry-title"><a href="#">ΧΑΒΑΛΕΝΘΙΑ vs €- FRIENDS </a></h4>
                    ...
                    <div class="item">
                        <article class="entry-item">
                            <div class="entry-thumb">
                                <a href="#"><img src="~/Content/images/slider/s3.png" alt=""></a>
                                <div class="thumb-hover"></div>
                            </div>
                            <div class="entry-content">
                                <h4 class="entry-title"><a href="#">ΧΑΒΑΛΕΝΘΙΑ vs €- FRIENDS </a></h4>
