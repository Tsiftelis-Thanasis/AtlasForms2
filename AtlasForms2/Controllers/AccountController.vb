...
Public Class AccountController
    ...
    Public Async Function Login(model As LoginViewModel, returnUrl As String) As Task(Of ActionResult)
        ...
        Dim user = Await UserManager.FindByNameAsync(model.Username)
    ...
    Public Async Function Register(model As RegisterViewModel) As Task(Of ActionResult)
        If ModelState.IsValid Then
            ...
            If result.Succeeded Then
                ...
                Dim aspdb As New atlasEntities
                ...
                'check if is the first user
                Dim firstuser = (From t In aspdb.AspNetUsers).Count
    ...
    Public Function LogOff() As ActionResult
        ...
        'If userisloged > 0 Then
        '    Dim finduser = webdb.UserLogins.Find(userisloged)
        '    webdb.UserLogins.Remove(finduser)
        '    webdb.SaveChanges()
        'End If
